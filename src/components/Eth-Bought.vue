<template lang="html">
  <div class="eth-bought__container">
    ...
    <p class="eth-bought__container text-color--matryx-blue">For BTC &#38; LTC purchases, please contact us at: <a href="mailto:team@matryx.ai?subject=Matryx Token Sale"
