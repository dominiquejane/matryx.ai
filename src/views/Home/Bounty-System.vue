<template>
  <section class="bkg--blue-gradient" id="bounty-system">
    <div class="content-container content-container--large text-color--white">
      ...
      <h4 class="text-align-center white"><span v-if=" language === 'ru' ">Как это работает</span>
      ...
      <br/>
        <p>
        <span>EXAMPLE</span>
          <br/>To illustrate the Matryx workflow, let us assume that the <span class="matryx-lighter-blue">fictious company</span> Marshal Aviations seeks to develop a spacecraft to boldly go to infinity and beyond, and is willing to devote a generous development budget of 100,000 MTX for this purpose.
